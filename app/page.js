...
export default function Home() {
  // Onboarding
  const [screen,       setScreen]       = useState("onboard")   // "onboard" | "dashboard"
      ...
      <div style={{ maxWidth: 480, margin: "0 auto", minHeight: "100vh", padding: "0 20px", display: "flex", flexDirection: "column" }}>
          ...
          {[1, 2, 3].map(s => (
            <div
              ...
              style={{
                ...
                width: s === step ? 24 : 6,
                background: s < step ? "rgba(167,139,250,0.5)" : s === step ? "#A78BFA" : "rgba(255,255,255,0.1)",
                transition: "all 0.2s",
              }}
            />
          ))}
        ...
        {step === 1 && (
          <div style={{ flex: 1 }}>
            ...
            <input
              ...
              autoFocus
              style={{ display: "block", width: "100%", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 12, padding: "14px 16px", color: "#E8E6E1", fontSize: 15, fontFamily: "inherit", outline: "none", boxSizing: "border-box", marginBottom: 10 }}
            />
            ...
            <input
              ...
              style={{ display: "block", width: "100%", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 12, padding: "14px 16px", color: "#E8E6E1", fontSize: 15, fontFamily: "inherit", outline: "none", boxSizing: "border-box", marginBottom: 8 }}
            />
            <p style={{ fontSize: 11, color: "#4B4540", marginTop: 0, marginBottom: 32 }}>Spotify integration coming soon — enter your URL now and we{"'"}ll pull your real stats when it{"'"}s ready.</p>

            <button
              onClick={() => artistName.trim() && setStep(2)}
              disabled={!artistName.trim()}
              style={{ display: "block", width: "100%", background: artistName.trim() ? "#7C3AED" : "rgba(124,58,237,0.25)", border: "none", borderRadius: 12, padding: "15px", color: artistName.trim() ? "#fff" : "#6B6560", fontSize: 14, fontWeight: 500, fontFamily: "inherit", cursor: artistName.trim() ? "pointer" : "not-allowed", transition: "all 0.15s" }}
            >
              Continue
            </button>
          </div>
              ...
              {GENRE_OPTIONS.map(g => {
                ...
                return (
                  <button
                    ...
                    style={{ background: active ? meta.bg : "rgba(255,255,255,0.03)", border: "1px solid", borderColor: active ? meta.border : "rgba(255,255,255,0.07)", borderRadius: 12, padding: "14px 16px", textAlign: "left", cursor: "pointer", fontFamily: "inherit", transition: "all 0.15s" }}
                  >
        ...
        {step === 3 && (
          <div style={{ flex: 1 }}>
            ...
            <p style={{ fontSize: 13, color: "#8B8680", marginBottom: 22, lineHeight: 1.6 }}>Pick any words that fit. These help us tailor your content strategy. You can skip this step.</p>
              ...
              {VIBE_OPTIONS.map(v => {
                ...
                return (
                  <button
                    ...
                    style={{ background: active ? "rgba(167,139,250,0.15)" : "rgba(255,255,255,0.04)", border: "1px solid", borderColor: active ? "rgba(167,139,250,0.4)" : "rgba(255,255,255,0.08)", borderRadius: 99, padding: "8px 15px", color: active ? "#C4B5FD" : "#8B8680", fontSize: 13, fontFamily: "inherit", cursor: "pointer", transition: "all 0.15s" }}
                  >
                    {v}
                  </button>
                )
  ...
  return (
    <div style={{ maxWidth: 480, margin: "0 auto", minHeight: "100vh" }}>
      ...
      <div style={{ padding: "28px 20px 0", background: "linear-gradient(180deg, rgba(139,92,246,0.08) 0%, transparent 100%)" }}>
        ...
        {/* Branding + edit button */}
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
          <Logo />
          <button
            onClick={editProfile}
            style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 8, padding: "6px 12px", color: "#8B8680", fontSize: 12, fontFamily: "inherit", cursor: "pointer" }}
          >
            Edit profile
          </button>
        </div>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ display: "flex", gap: 5, flexWrap: "wrap" }}>
                ...
                {selectedVibes.slice(0, 3).map(v => (
                  <span key={v} style={{ fontSize: 10, color: "#8B8680", background: "rgba(255,255,255,0.04)", padding: "1px 7px", borderRadius: 99 }}>{v}</span>
                ))}
                {selectedVibes.length > 3 && (
                  <span style={{ fontSize: 10, color: "#6B6560" }}>+{selectedVibes.length - 3} more</span>
                )}
              </div>
            </div>
            {/* Spotify link if provided */}
            {spotifyUrl && (
        ...
        <div style={{ display: "flex", gap: 0, borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
          {tabs.map(t => (
            <button
              ...
              style={{ background: "none", border: "none", padding: "10px 16px", fontSize: 13, fontWeight: activeTab === t.id ? 500 : 400, color: activeTab === t.id ? "#A78BFA" : "#6B6560", cursor: "pointer", borderBottom: activeTab === t.id ? "2px solid #A78BFA" : "2px solid transparent", fontFamily: "inherit", transition: "all 0.15s" }}
            >
              {t.label}
            </button>
          ))}
          ...
          <div>
            ...
            {ideas.map(idea => {
              ...
              return (
                <div
                  key={idea.id}
                  onClick={() => setExpandedIdea(open ? null : idea.id)}
                  style={{ background: open ? "rgba(255,255,255,0.05)" : "rgba(255,255,255,0.02)", border: "1px solid", borderColor: open ? "rgba(167,139,250,0.3)" : "rgba(255,255,255,0.05)", borderRadius: 12, padding: "12px 14px", marginBottom: 6, cursor: "pointer", transition: "all 0.15s" }}
                >
          ...
          <div>
            ...
            {sounds.map((sound, i) => {
              ...
              return (
                <div
                  key={sound.id}
                  onClick={() => setExpandedSound(open ? null : sound.id)}
                  style={{ background: open ? "rgba(255,255,255,0.05)" : "rgba(255,255,255,0.02)", border: "1px solid", borderColor: sound.daysActive <= 2 ? "rgba(244,114,182,0.2)" : "rgba(255,255,255,0.05)", borderRadius: 12, padding: "12px 14px", marginBottom: 6, cursor: "pointer", transition: "all 0.15s" }}
                >
            ...
            {calendarItems.map((item, i) => {
              ...
              return (
                <div
                  ...
                  style={{ display: "flex", alignItems: "center", gap: 12, background: done ? "rgba(255,255,255,0.01)" : c.bg + "44", border: "1px solid", borderColor: done ? "rgba(255,255,255,0.03)" : c.dot + "22", borderRadius: 12, padding: "12px 14px", marginBottom: 5, cursor: "pointer", transition: "all 0.15s", opacity: done ? 0.5 : 1 }}
                >
