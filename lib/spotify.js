...
const GENRE_RULES = [
  ...
  { genre: 'Hip-Hop',    re: /hip.?hop|\brap\b|trap|drill|grime|afrobeats|afropop|cloud rap/ },
  // Drop \b around r&b — & is non-word so boundaries behave unexpectedly across engines;
  // "r&b" is distinctive enough without them. Also catch urban/contemporary tags.
  { genre: 'R&B',        re: /r&b|rnb|neo.?soul|\bsoul\b|\bfunk\b|quiet storm|urban contemporary|contemporary r|rhyth/ },
